...
<div class="col-md-3">
  ...
  <section id="testimonials">
    <h1 class="about d-flex justify-content-center">What people have to say</h1>
...
@font-face {
  font-family: game;
  src: url(../assets/Fonts/FiddlersCove/FiddlersCoveItalic-Yppj.otf);
}
@font-face {
  font-family: detail;
...
.gallery span{
  ...
  width: 100%;
  height: 100%;
  filter: drop-shadow(0px 0px 0.5rem red);
