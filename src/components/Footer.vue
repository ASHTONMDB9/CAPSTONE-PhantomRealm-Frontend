          ...
          <div class="col-xl-4 col-lg-4">
            <div class="footer-widget">
              ...
              <div class="footer-social-icon">
                ...
                ></a>
                <a href="https://twitter.com/ASHTON_M_DB9" target="_blank"
                ...
                ></a>
                <a href="https://github.com/ASHTONMDB9" target="_blank"
          ...
          <div class="col-xl-4 col-lg-4 col-md-6 mb-50">
            <div class="footer-widget">
              ...
              <div class="footer-text mb-25">
                <p>
                  To join our community send us your email and we'll get back to
                  you
                </p>
              </div>
        ...
        <div class="row">
          <div class="col-xl-6 col-lg-6 text-center text-lg-left">
            <div class="copyright-text">
              <p>
                Phantomslaye_4427 (Ashton.A) Copyright &copy; 2022, All Right
                Reserved
              </p>
            </div>
          </div>
