  ...
  <div v-if="user_type === 'Admin'">
      ...
      <div class="d-flex align-items-center ms-4 mb-4">
        <div class="position-relative">
          <img
            ...
            src="../assets/Images/possible/cf468dcf-8938-4f68-a0d4-272d2091af53.jpeg"
            alt=""
            style="width: 60px; height: 60px"
          />
          <div
            class="bg-success rounded-circle border border-2 border-white position-absolute end-0 bottom-0 p-2"
          ></div>
        </div>
        <div class="ms-3">
          <h6 class="mb-0 text-light">
            Ashton -<span class="text-success"> online</span><br />
          </h6>
    ...
    <div id="profit" class="container-fluid">
      <div class="row">
        <div class="col-md-3">
          <div
            class="bg-dark text-light rounded d-flex align-items-center justify-content-between p-4"
          >
        ...
        <div class="row g-4">
          <div class="col-md-6">
            <div class="bg-dark rounded h-100 p-4">
              ...
              <img
                src="../assets/Images/singleline.png"
                id="line-chart"
          ...
          <div class="col-md-6">
            <div class="bg-dark rounded h-100 p-4">
              ...
              <img
                src="../assets/Images/multibar.png"
                id="salse-revenue"
                style="display: block; margin-left: auto; margin-right: auto"
              />
            </div>
          ...
          <div class="col-md-6">
            <div class="bg-dark rounded h-100 p-4">
              ...
              <img
                src="../assets/Images/singlebar.png"
                id="bar-chart"
                style="display: block; margin-left: auto; margin-right: auto"
              />
            </div>
          ...
          <div class="col-md-6">
            <div class="bg-dark rounded h-100 p-4">
              ...
              <img
                src="../assets/Images/multiline.png"
                id="worldwide-sales"
                style="display: block; margin-left: auto; margin-right: auto"
              />
            </div>
                          ...
                          <form @submit.prevent="UpdateProduct(product)">
                            ...
                            <div>
                              <textarea
                                ...
                                placeholder="description"
                                style="height: 330px; width: 680px"
                                required
                              ></textarea>
                            </div>
                            <div>
